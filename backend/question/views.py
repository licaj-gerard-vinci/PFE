...
from backend.models import Questions, Reponses, ReponseClient
...
class GetQuestionsAndReponsesView(APIView):
    def get(self, request):
        ...
        for q in questions:
            ...
            reponses = Reponses.objects.filter(id_question=q.id_question).distinct('texte')
            ...
            reponses_data = [
                {
                    ...
                    "texte": r.texte,
                    "score_individuelle": r.score_individuel,
